...
const URL = "https://10lshk6jdtrtrgmz-en-code-server.cfapps.eu10.hana.ondemand.com/xsjs/get/QR.xsjs"
  ...
  let servidor = {
    ...
    enviar_ganadores_pantalla: function (ganadores) {
      if (ganadores != null) {
        ...
        var pantalla = this.buscar_id('screen_trivia');
        pantalla.sendUTF(this.json_msj({ type: 'win_txt', nombres: ganadores }));
      }
      else {
        var pantalla = this.buscar_id('screen_trivia');
